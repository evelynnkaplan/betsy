...
describe OrderItemsController do
  ...
  describe "update" do
    ...
    it "doesn't updates quantity for item in another cart" do
      order_item = OrderItem.first 
      old_quantity = order_item.quantity

      expect(order_item.quantity).wont_equal @update_order_item[:order_item][:quantity]
      ...
      expect(old_quantity).must_equal order_item.quantity
